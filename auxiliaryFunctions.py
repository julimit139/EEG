...
def calculateFourier(calcList):
    ...
    # numerator = integrate.quad(func=retCalcList, a=0, b=gV.lambdaFrequency, args=calcList)[0]
    # denominator = integrate.quad(func=retCalcList, a=0, b=gV.nyquistFrequency, args=calcList)[0] - integrate.quad(func=retCalcList, a=gV.electricFrequency - 2, b=gV.electricFrequency + 2, args=calcList)[0]
